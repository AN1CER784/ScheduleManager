...
class UserRegisterViewTestCase(TestCase):
    def test_register(self):
        response = self.client.post(reverse('users:signup'),
                                    {'username': 'XXXX', 'password1': 'LLLL1111', 'password2': 'LLLL1111'},
                                    follow=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_register_invalid_password2(self):
        response = self.client.post(reverse('users:signup'),
                                    {'username': 'XXXX', 'password1': 'LLLL1111', 'password2': 'LLLL2222'},
                                    follow=True)
        self.assertEqual(response.status_code, 200)
...
class UserProfileViewTestCase(TestCase):
    ...
    def test_profile_change(self):
        response = self.client.post(reverse('users:profile'),
                                    {'username': 'XXXX', 'password1': '1111', 'password2': 'LLLL1111',
        ...
        self.assertTrue(user.check_password('LLLL1111'))
